package com.ayurvedahome.data.mapper
...
object DataMappers {
    ...
    fun toEntity(game: AyurvedaHomeGame): GameEntity = GameEntity(
        id = game.id,
    ...
    fun fromEntity(entity: GameEntity): AyurvedaHomeGame {
