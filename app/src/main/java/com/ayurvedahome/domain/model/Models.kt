package com.ayurvedahome.domain.model
...
/** Sort palette index 0..N-1 mapped to UI colors in [AyurvedaHomePalette]. */
data class AyurvedaHomeLevel(
    val id: Long = 0,
    val seed: Long,
    val levelNumber: Int,
    val difficulty: Difficulty,
    val initialTubes: List<List<Int>>,
    val tubeCapacity: Int = AyurvedaHomeLevel.DEFAULT_CAPACITY,
    val colorCount: Int,
