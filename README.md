...
1. Open `D:\Work\Games\AyurvedaHome` in Android Studio.
...
The project is scaffolded from PuzzleVerse. Replace `engine/ScrewPuzzleEngine.kt` with `AyurvedaHomeEngine.kt` (tube pour logic) and update the game board UI component.
