#!/usr/bin/env python3
"""Generate AyurvedaHome Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\AyurvedaHome")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "ayurvedahome"
TEST = APP / "src" / "test" / "java" / "com" / "ayurvedahome"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "ayurvedahome"
...
android {
    namespace = "com.ayurvedahome"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.ayurvedahome.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.ayurvedahome.data.** { *; }
-keep class com.ayurvedahome.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "ayurvedahome-game",
    "storage_bucket": "ayurvedahome-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.ayurvedahome.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating AyurvedaHome project files...")
